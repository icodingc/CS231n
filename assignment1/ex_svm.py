...
# from cs231n.mnist_loader import load_data_wrapper
...
for l_r_cv in learning_rates:
	for r_s_cv in regularization_strengths:
		svm = LinearSVM()
		svm.train(X_train, y_train, learning_rate=l_r_cv, reg=r_s_cv,
                      num_iters=1500, verbose=True)
		y_train_pred = svm.predict(X_train)
...
# lr 3.000000e-07 reg 1.000000e+04 train accuracy: 0.415444 val accuracy: 0.396000
...
# Better than notebook's accuracy.
