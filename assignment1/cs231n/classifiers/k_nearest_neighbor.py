#when exe the code,should care about the shape of X,y
import numpy as np
...
class KNearestNeighbor:
  ...
  #http://misaka-10032.github.io/2015/02/01/cs231n-assignment-1/
  #refer
  def compute_distances_no_loops(self, X):
    ...
    #vector to matrix:two way,
    #np.matrix(a)     a.reshape(-1,1)
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      # count_ = [0]*10
      # for j in xrange(k):
      #     count_[closest_y[j]] += 1
      # y_pred[i] = np.argmax(count_)
